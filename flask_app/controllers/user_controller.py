...
def welcome():
    ...
    all_paintings = Painting.get_all_paintings() # Band is the class and it is calling the get_all_bands and displaying that info in Welcome page. FUNCTION was cerated in BAND.PY.
    return render_template("welcome.html", user = logged_in_user, all_paintings = all_paintings) # This is the way we can render more things on the template. 
